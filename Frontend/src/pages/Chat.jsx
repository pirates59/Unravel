            ...
            <div key={index} className={`flex ${isCurrentUser ? "justify-end" : "justify-start"}`}>
              {!isCurrentUser && (
                <div className="flex-shrink-0 w-9 h-9 rounded-full overflow-hidden">
                  <img
                    src={msg.senderImage || "http://localhost:3001/uploads/default.png"}
                    alt={msg.senderName}
              ...
              <div className="mx-2 max-w-xl">
                <div className={`rounded-md shadow p-3 text-sm ${isCurrentUser ? "bg-[#7879F1] text-white" : "bg-white text-gray-800"}`}>
                  {msg.text}
                </div>
              ...
              {isCurrentUser && (
                <div className="flex-shrink-0 w-9 h-9 rounded-full overflow-hidden">
                  <img
                    src={currentUser.image || "http://localhost:3001/uploads/default.png"}
