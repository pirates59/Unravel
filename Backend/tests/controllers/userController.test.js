...
describe('userController.deleteUser', () => {
  ...
  it('should delete user successfully', async () => {
    ...
    expect(Post.deleteMany).toHaveBeenCalledWith({ authorId: userId });
    expect(Comment.deleteMany).toHaveBeenCalledWith({ authorId: userId });
    expect(Notification.deleteMany).toHaveBeenCalledWith({ actorId: userId });
    expect(res.json).toHaveBeenCalledWith({ message: 'User and related data deleted successfully.' });
  });
